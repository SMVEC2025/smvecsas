...
function BioScience() {
  ...
  const HodData={
    image:"https://d23qowwaqkh3fj.cloudfront.net/wp-content/uploads/2022/05/5-1-scaled.webp",
    name:"Dr. Kavitha A",
  ...
  return (
   <>
    ...
    <Faculty dept="bioscience"/>
    <HomeNewsAndEvents title="SMVEC Events"  dept="bioscience" eventurl="/events/bioscience"/>
    <HomeCta/>
   </>
  )
}
